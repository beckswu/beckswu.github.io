...
E.g. bigrams are all sets of two words that appear side by side in corpus. <span style="color:red">Notes: 下面例子, I am appear twice, 但是only include 一次在 bigram set</span>
...
$$ \text{Bigrams: \{I am, am happy, happy because,...\}},note: \color{red}{ \cancel{I happy} } $$