...
Problem with Euclidean distance:  Vector space where corpora are represented by occurrence of the words "disease" and "eggs". Agriculture and history corpus has a similar number of words. Suggests agriculture and history corpora are more similar than agriculture and food corpora
