...
- AND, OR, LESS : logical
- Difference between <span style="background-color:red">STREQUAL, EQUAL</span> is : EQUAL do the arithmatic comparison, STREQUAL is do string comparison
- elseif(MY_STRING MATCHES "string$") : <span style="background-color:red">"MATCH</span> regularization, match if string is the end of MY_STRING
