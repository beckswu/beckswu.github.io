...
\frac{d L \left( y_i,F_0\left(x \right)\right)}{da} &=\sum_{i=1}^m\left( -\frac{ y_i}{a}+ \frac{ 1- y_i}{ 1- a} \right)\\

\frac{d L \left( y_i,F_0\left(x \right)\right)}{dF_0\left( x\right)} &= \frac{d L \left( y_i,F_0\left(x \right)\right)}{da} \frac{da}{dF_0\left( x\right)} \\
