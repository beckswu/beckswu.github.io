...
- Then use full data to build the tree, and when calculate **Gain** and **Similarity** <span style="color:red">then put missing data with residual on both left tree and right tree</span>
- Then choose the threshold which give the largest **Gain**
  - <span style="color:red">When at evaluation, if still have missing value, the default path of missing value is left tree at this selected threshold</span>
