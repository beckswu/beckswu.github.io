...
$$ \space \space \space \space \space \space \space A^T\left(\vec x - Proj_v \vec x \right) = \vec 0 $$ <br/>
$$ \space \space \space \space \space \space \space A^T \vec x - A^T Proj_v \vec x  = \vec 0 $$ <br/>
$$ \space \space \space \space \space \space \space A^T \vec x = A^T A \vec y  $$ <br/>
$$ \space \space \space \space \space \space \space \vec y = \left(A^T A \right)^{-1}  A^T \vec x $$ <br/>
$$ \space \space \space \space \space \space \space Proj_v \vec x  = A \left(A^T A \right)^{-1}  A^T \vec x   $$
