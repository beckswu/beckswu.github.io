...
- ```shared_ptr```: 
    ...
    - 如果constructor 是 shared_ptr, 递增计数器
    ...
    - dangerouse to use built-in pointer to access an object owned by smart pointer, 因为不知道什么object is destroyed

- dynamically allocated array: 
    - <span style="color:red">shared_ptr : 必须用 deleter, 否则删除就是 array 第一个元素</span>
