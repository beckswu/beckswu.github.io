...
- new standard lets a derived class explicitly note that it intends a member function to<span style="color:red"> **override** a virtual that it inherits</span>. It does so by <span style="color:red">specifying override after its parameter list</span>
