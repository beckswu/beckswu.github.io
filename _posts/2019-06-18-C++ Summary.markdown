...
The conditional operator has fairly low precedence. When we embed a conditional expression in a larger expression, 通常需要parathesize, 第二个语句 ```cout << grade;``` 返回的是coun
