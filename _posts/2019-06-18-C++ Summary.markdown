...
shared_ptr<int>p1 = new  = new int(1024);//error: must use direct initialization
...
5. 如果使用smart pointer to manage a resource other <span style="background-color:#FFFF00">a resource other than memory allocated by new, remember to pass a deleter</span>
