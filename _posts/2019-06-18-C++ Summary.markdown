...
- class 的member template cannot be virtual. class template parameter come first, then member parameter list 
-  explicit instantiation: ```extern```
    ...
    - explicit instantiation: compiler instantiates all member of that class
