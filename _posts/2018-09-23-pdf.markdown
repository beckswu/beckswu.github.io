...
<object data="/document/C#.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="/document/C#.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="/document/C#.pdf">Download PDF</a>.</p>
    </embed>
</object>